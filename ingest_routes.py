...
def process_ingest_job(job_id: UUID) -> None:
    # Optional “stamp” you said you added. Keeping it here is fine.
    ...
    try:
        ...
        for item in items:
            ...
            try:
                ...
                # ✅ NEW: compute hash from the raw bytes before any text extraction
                ...
                ingest_document_text(
                    ...
                    file_hash=file_hash,  # ✅ NEW: persist hash + enable dedupe
                )
